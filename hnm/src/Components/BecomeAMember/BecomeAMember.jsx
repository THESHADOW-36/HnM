...
const BecomeAMember = ({ display, setDisplay, bamDisplay, setBamDisplay }) => {

   function bamCloseButton() {
      setDisplay(display => !display)
      setBamDisplay(bamDisplay => !bamDisplay)
   }
   function signInSite() {
      setBamDisplay(bamDisplay => !bamDisplay)
   }
                  ...
                  <div className="bam-lay">
                     <div className="bam">
                        ...
                        <div className="bam-top">
                           <p>BECOME A MEMBER</p>
                           <div className="close-mark" onClick={bamCloseButton}><i class="fa-solid fa-xmark"></i></div>
                        </div>
