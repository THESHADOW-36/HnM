   ...
   return (
      <div className="footer">
         <div className="footer-box">
            ...
            <div className="footer5-15pro-nav">
               <div className="f5-apple-logo"><i class="fa-brands fa-apple fa-lg"></i></div>
               <div className="f5-15pro-right-arrow"><i class="fa-solid fa-chevron-right"></i></div>
               <p>iPhone</p>
               <div className="f5-15pro-right-arrow"><i class="fa-solid fa-chevron-right"></i></div>
               <p>iPhone 15 Pro</p>
            </div>
